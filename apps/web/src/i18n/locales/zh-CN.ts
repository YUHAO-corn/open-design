...
export const zhCN: Dict = {
  ...
  'pluginApply.inputsMissing': '缺少必填的插件输入：{fields}',
  'pluginApply.configurationInvalid': '插件配置无效。请重新安装或更新插件后重试。',
  'pluginApply.resourceUnavailable': '所需的插件资源不可用。请重新安装或更新插件后重试。',
  'pluginApply.genericFailure': '无法应用插件，请重试。',
  'pluginApply.workspaceContextIncomplete': '工作区上下文不完整。请等待工作区同步完成后重试。',
  'pluginApply.notFound': '未找到插件。',
  'pluginApply.failedNamedWithReason': '无法应用 {plugin}：{reason}',
